    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#services">Seviços</a></li>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    {{-- <i ></i> --}}
                    {{-- <img src="https://clinicadacidade.com.br/wp-content/webp-express/webp-images/uploads/2022/03/icone-3.png.webp" alt=""> --}}
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Camed</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
